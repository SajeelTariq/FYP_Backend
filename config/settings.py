...
APIFY_FB_POSTS_ACTOR_ID = os.getenv('APIFY_FB_POSTS_ACTOR_ID', 'parseforge~facebook-posts-scraper')
APIFY_FB_PAGE_ACTOR_ID = os.getenv('APIFY_FB_PAGE_ACTOR_ID', 'parseforge~facebook-pages-scraper')
